							...
							<div class="card-body">
								...
								<div class="form-group">
									<label>Vị trí</label> <input type="text" class="form-control"
										id="location" name="location" value="${book.getLocation()}">
								</div>
								<div class="form-group">
									<label>Tác giả</label> <input type="text" class="form-control"
										id="tacgia" name="tacgia" value="${book.getTacgia()}">
								</div>
								<div class="form-group">
									<label>Nhà xuất bản</label> <input type="text" class="form-control"
										id="nxb" name="nxb" value="${book.getNxb()}">
								</div>
								
							</div>
							<div class="card-footer">
								<button type="submit" class="btn btn-primary ">Lưu</button>
								<a type="button" value="Trở lại" class="btn btn-primary"
									onclick="location.href='${pageContext.request.contextPath}/ManageBook'">Trở lại</a>
							</div>
						</form>
					</div>
					<!-- /.card -->
